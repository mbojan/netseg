...
Artificial example data from Echenique & Fryer (2006) Figure III
...
- `name` – vertex names of the form "A1" in which letter and number
  indicate the position in the lattice

- `race` – values 1 or 2 indicate the two groups

## Source

Echenique, Federico and Roland G. Fryer, Jr. (2006) "A Measure of
Segregation Based On Social Interactions" *Quarterly Journal of
Economics* CXXII(2):441-485
